...
# processor-file-specific mappings were introduced.
if engine.dialect.name == "postgresql":
    with engine.begin() as connection:
        connection.execute(text(
            "ALTER TABLE column_mappings ADD COLUMN IF NOT EXISTS processor_upload_id UUID REFERENCES uploads(id)"
        ))
        connection.execute(text("ALTER TYPE reconciliationstatus ADD VALUE IF NOT EXISTS 'DUPLICATE'"))
